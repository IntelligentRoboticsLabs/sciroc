...
#define CHECK_TABLE_CHECKING_TIME   30.0

#define CHECK_TABLE_MIN_PROBABILITY   0.3

#define CHECK_TABLE_PERSON_MIN_X   -1.2
#define CHECK_TABLE_PERSON_MAX_X   1.2
#define CHECK_TABLE_PERSON_MIN_Y   -1.2
#define CHECK_TABLE_PERSON_MAX_Y   1.2
...
#define CHECK_TABLE_PERSON_MAX_SIZE_X   1.4
#define CHECK_TABLE_PERSON_MAX_SIZE_Y   1.4
#define CHECK_TABLE_PERSON_MAX_SIZE_Z   2.2

#define CHECK_TABLE_OBJECT_MIN_X   -0.9
#define CHECK_TABLE_OBJECT_MAX_X   0.9
#define CHECK_TABLE_OBJECT_MIN_Y   -0.9
#define CHECK_TABLE_OBJECT_MAX_Y   0.9
#define CHECK_TABLE_OBJECT_MIN_Z   0.7
#define CHECK_TABLE_OBJECT_MAX_Z   1.2
#define CHECK_TABLE_OBJECT_MIN_SIZE_X   0.04
#define CHECK_TABLE_OBJECT_MIN_SIZE_Y   0.04
#define CHECK_TABLE_OBJECT_MIN_SIZE_Z   0.04
#define CHECK_TABLE_OBJECT_MAX_SIZE_X   0.6
#define CHECK_TABLE_OBJECT_MAX_SIZE_Y   0.6
#define CHECK_TABLE_OBJECT_MAX_SIZE_Z   0.6
