...
#define CHECK_WAITING_PERSON_CHECKING_TIME   20.0
#define CHECK_WAITING_PERSON_MIN_PROBABILITY   0.4


#define CHECK_WAITING_PERSON_MIN_X   -1.0
#define CHECK_WAITING_PERSON_MAX_X   1.0
#define CHECK_WAITING_PERSON_MIN_Y   -1.0
#define CHECK_WAITING_PERSON_MAX_Y   1.0
