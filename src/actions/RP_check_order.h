...
#define CHECK_ORDER_MIN_PROBABILITY   0.75


#define CHECK_ORDER_OBJECT_MIN_X   -1.0
#define CHECK_ORDER_OBJECT_MAX_X   1.0
#define CHECK_ORDER_OBJECT_MIN_Y   -1.0
#define CHECK_ORDER_OBJECT_MAX_Y   1.0
...
#define CHECK_ORDER_OBJECT_MAX_SIZE_X   0.6
#define CHECK_ORDER_OBJECT_MAX_SIZE_Y   0.6
#define CHECK_ORDER_OBJECT_MAX_SIZE_Z   0.6
